import '../css/RightSideLeftMain.css';
...
const RightSideLeftMain = () => (
  ...
  >
    ...
    <div style={{ marginBottom: '16px' }}>
      <div style={{ marginBottom: '7px', fontSize: '10px' }} className="text-center">Click an item Below for more Details!</div>
      <div style={{ fontSize: '12px', textAlign: 'center' }} className="d-flex align-items-center justify-content-center flex-wrap">
        <div
          className="right-side-left-item"
          style={{
            width: '164.88px', height: '38px', marginBottom: '8px', padding: '10px'
          }}
        >
          <span style={{ marginRight: '3px' }}>DxWarnings</span>
          <span style={{
            width: '14px', backgroundColor: '#2196F3', color: 'white', fontSize: '8px', padding: '1.5px 5px', borderRadius: '50%'
          }}
          >
            1
          </span>
        ...
        >
          <span style={{ marginRight: '3px' }}>TokenSniifer</span>
          <span style={{
            width: '14px', backgroundColor: '#2196F3', color: 'white', fontSize: '8px', padding: '1.5px 5px', borderRadius: '50%'
          }}
          >
        ...
        >
          <span style={{ marginRight: '4px' }}>Not Audited</span>
          <span style={{ color: '#be513b' }}><i className="fas fa-ban" /></span>
        </div>
        <div
          className="right-side-left-item"
          style={{
        ...
        >
          <span style={{ marginRight: '4px' }}>Not KYCed</span>
          <span style={{ color: '#be513b' }}><i className="fas fa-ban" /></span>
        </div>
      </div>
    </div>
    <div style={{
      width: '337.75px', height: '56px', backgroundColor: '#F0F2FF', padding: '10px', textAlign: 'center', fontSize: '11px', borderRadius: '8px', marginBottom: '16px'
    }}
    >
      <div>Estimated Initial Marketcap:</div>
      <div>$0</div>
    </div>
    <div style={{ fontSize: '10.2px' }}>
