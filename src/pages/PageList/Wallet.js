...
const columns = [
    { title: 'Address', isSortable: true, id: 'address' },
...
const Wallet = () => {
    ...
    useEffect(async () => {
        const { data } = await axiosGet('admin/wallet/getAll')
                                ...
                                .map((data, index) => {
                                    return (
                                        <TableRow key={data.id}>
                                            ...
                                            <TableCell component="th" scope="row">
                                                <Switch id={data.id} defaultChecked={data.isActive === "1"} onChange={toggleActiveWallet} />
                                            </TableCell>
                                            {/* <TableCell component="th" scope="row">
